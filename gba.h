...
#define GRASS COLOR(6,17,6)
#define DARKGRAY COLOR(7,7,7)
#define DARKRED COLOR(18,0,3)
#define DARKBLUE COLOR(12,18,29)
#define BROWN COLOR(18,9,0)
#define ORANGE COLOR(29,18,4)
#define DARKBROWN COLOR(11,5,4)
