...
void initialize() {
    ...
    *(volatile u16*)0x04000080 = (((5) & 7) << 0) | (((5) & 7) << 4) | (1 << 8) | (1 << 12) |
                     (1 << 9) | (1 << 13) | (1 << 10) | (1 << 14) | (1 << 11) |
                     (1 << 15);
    goToStart();
}
...
void goToStart() {
    ...
    drawString(10, 10, "roady cross", ((31) | (31)<<5 | (31)<<10));
    drawString(10, 30, "press SELECT to begin", ((31) | (31)<<5 | (31)<<10));
    drawRect(240 / 2, 80, 50, 50, ((18) | (9)<<5 | (0)<<10));
    drawRect(240 / 2 - 6, 80, 10, 5, 0);
    drawRect(240 / 2 - 6, 80, 5, 20, 0);
    drawRect(240 / 2 + 46, 80, 10, 5, 0);
    drawRect(240 / 2 + 51, 80, 5, 20, 0);
    drawRect(240 / 2 + 8, 90, 10, 10, ((31) | (31)<<5 | (31)<<10));
    drawRect(240 / 2 + 32, 90, 10, 10, ((31) | (31)<<5 | (31)<<10));
    drawRect(240 / 2 + 36, 91, 3, 8, 0);
    drawRect(240 / 2 + 11, 91, 3, 8, 0);
    drawRect(240 / 2 + 21, 108, 8, 5, 0);
    drawRect(240 / 2 + 24, 108, 2, 15, 0);
    drawRect(240 / 2 + 20, 122, 10, 2, 0);
    drawRect(240 / 2 + 20, 120, 2, 2, 0);
    drawRect(240 / 2 + 28, 120, 2, 2, 0);
    drawRect(240 / 2 - 5, 135, 60, 25, ((18) | (9)<<5 | (0)<<10));
    drawRect(240 / 2 + 2, 130, 46, 5, ((31) | (0)<<5 | (31)<<10));
    currState = START;
}
...
void goToGame() {
    currState = GAME;
    background();
    drawString(5, 20, "lives: ", 0);
    drawString(189, 20, "coins: ", 0);
}
...
void game() {
    ...
    drawString(100, 12, "ROADY", 0);
    drawString(100, 22, "CROSS", 0);
    waitForVBlank();
    drawRect(41, 20, 10, 10, ((6) | (17)<<5 | (6)<<10));
    drawRect(225, 20, 10, 10, ((6) | (17)<<5 | (6)<<10));
    drawString(41, 20, buff1, 0);
    drawString(225, 20, buff2, 0);
    drawGame();
    if ((!(~(oldButtons) & ((1<<2))) && (~buttons & ((1<<2))))) {
        goToPause();
    }
...
void goToPause() {
    currState = PAUSE;
    fillScreen(((29) | (18)<<5 | (4)<<10));
    drawString(102, 10, "paused", 0);
}
...
void goToWin() {
    ...
    drawString(75, 20, "yay :) you won!", 0);
}
...
void goToLose() {
    ...
    drawString(54, 20, "you lost :( tough luck", 0);
}
